...
const ReservaPaqueteList: React.FC<ReservaPaqueteListProps> = ({ reservas, onDelete }) => {
              ...
              <tr key={reserva.id}>
                ...
                <td>
                  <div className="reserva-paquete-info">
                    ...
                    <small>{formatDate(reserva.paquete?.fecha_ini)} - {formatDate(reserva.paquete?.fecha_fin)}</small>
                  </div>
                </td>
                <td>
