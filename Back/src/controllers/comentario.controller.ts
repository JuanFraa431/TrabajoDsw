...
async function findAll(req: Request, res: Response) {
  try {
    ...
    res
      .status(200)
      .json({ message: "Comentarios encontrados", data: comentarios });
  } catch (error: any) {
...
async function findOne(req: Request, res: Response) {
  try {
    ...
    res
      .status(200)
      .json({ message: "Comentario encontrado", data: comentario });
  } catch (error: any) {
    res.status(500).json({ message: error.message });
  }
}
...
async function remove(req: Request, res: Response) {
  try {
    ...
    return handleDatabaseError(error, res, "Comentario");
  }
}
